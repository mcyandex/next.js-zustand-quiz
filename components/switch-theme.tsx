...
const SwitchTheme = () => {
  ...
  return (
    <div className="flex items-center gap-x-2">
      <Image src={darkMode ? "/assets/images/icon-sun-light.svg": "/assets/images/icon-sun-dark.svg"} alt="sun" width={20} height={20} />
      ...
      <Image src={darkMode ? "/assets/images/icon-moon-light.svg": "/assets/images/icon-moon-dark.svg"} alt="moon" width={20} height={20} />
    </div>
  );
};
